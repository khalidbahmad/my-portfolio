...
const ICONS = {
  code: (
    <svg className="h-6 w-6" style={{ color: 'var(--accent-blue)' }} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            <div className="flex" style={{ gap: '1rem' }}>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M4.98 3.5C3.88 3.5 3 4.38 3 5.48s.88 1.98 1.98 1.98 1.98-.88 1.98-1.98S6.08 3.5 4.98 3.5zM3.5 8h3v12h-3V8zm7 0h2.88v1.71h.04c.4-.76 1.38-1.55 2.85-1.55 3.05 0 3.61 2.01 3.61 4.63V20h-3v-5.36c0-1.28-.02-2.94-1.79-2.94-1.8 0-2.07 1.41-2.07 2.84V20h-3V8z" />
                </svg>
                LinkedIn
              </a>
            </div>
          ...
          <div className="order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="card relative overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1596003906949-67221c37965c?auto=format&fit=crop&w=800&q=80"
                  alt="Workspace"
                  style={{
                    width: '100%',
                    height: 'auto',
