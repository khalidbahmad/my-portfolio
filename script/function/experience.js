                    ...
                    <div>
                        ...
                        <!-- Licences et certifications -->
                         <div>
                            <div class="flex items-center mb-8">
                                <div class="w-12 h-12 rounded-full bg-purple-500/20 flex items-center justify-center mr-4">
                                    <i data-feather="award" class="text-purple-500 h-6 w-6"></i>
                                </div>
                                <h3 class="text-2xl font-bold">Licences & Certifications</h3>
                            </div>
                            <div id="certifications-timeline" class="relative pl-8 border-l-2 border-gray-200 dark:border-gray-700 space-y-12"></div>
                        </div>
                    </div>
                </div>
            </div>
